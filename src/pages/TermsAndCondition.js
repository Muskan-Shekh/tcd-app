...
const TermsAndCondition = () => {
  return (
    <div>
      ...
      >
        <div className="overlay-about-us-img"></div>
      ...
      <div className="container">
        <div className="terms-about">
          ...
          <p className="terms-about-p2">
            To make this reader-friendly, we have divided these Terms of Use
            into four sections. These are:
          </p>
          <ul>
            <li> 1. Acceptance of the Terms</li>
            <li>2. Terms of Use of the Platform</li>
            <li>3. Acceptance of the Terms</li>
            <li>4. Acceptance of the Terms</li>
          </ul>
        </div>

        <div className="acceptance-of-the-terms">
        ...
        <div className="legel-conditions">
          ...
          <span>• Prevailing Language: The English language version of these Terms shall be decisive in all respects and shall prevail in case of any inconsistencies with translated versions if any.</span>
          <span>ENTITY NAME: The Indian Food Company, Plot No. 357, Raja Park, 302004, Jaipur. <a href="#">Email address: team@thecorrectdiet.com and inquiries@thecorrectdiet.com</a></span>
        </div>
      </div>
    </div>
  );
