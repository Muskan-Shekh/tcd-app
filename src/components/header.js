...
import hamBurgerImage from "../assets/hamburger-icon.svg";
...
const Header = () => {
    ...
    return (
        ...
        >
            <div className="container d-lg-block d-none desktop_header">
                    ...
                    >
                        <ul className="menu_bar">
                            <li>
                                <Link
                                    to="/"
                                    className={`text-decoration-none ${activeLink === "/" ? "active" : "text-white"
                                        }`}
                                    onClick={() => handleClick("/")}
                                    style={{
                                        fontWeight: "500",
                            ...
                            <li className="dropdown">
                                <Link
                                    to="/our-meals"
                                    className={`text-decoration-none ${activeLink === "/our-meals" ? "active" : "text-white"
                                        }`}
                                ...
                                <ul class="dropdown-menu">
                                    <li><Link className="dropdown-item" to="/">Our Meals1</Link></li>
                                    <li><Link className="dropdown-item" to="/">Our Meals2</Link></li>
                                    <li><Link className="dropdown-item" to="/">Our Meals3</Link></li>
                                    <li><Link className="dropdown-item" to="/">Our Meals4</Link></li>
                                </ul>
                            </li>
                            <li>
                                <Link
                                    to="/about-us"
                                    className={`text-decoration-none ${activeLink === "/about-us" ? "active" : "text-white"
                                        }`}
                            ...
                            <li>
                                <Link
                                    to="/contact-us"
                                    className={`text-decoration-none ${activeLink === "/contact-us" ? "active" : "text-white"
                                        }`}
                                    style={{ fontWeight: "500", transition: "all 500ms ease 0ms" }}
            ...
            <nav className="navbar d-lg-none d-block p-0 mobile_header">
                        ...
                        <div className="offcanvas-body" bis_skin_checked="1">
                            ...
                            >
                                <li>
                                    <Link
                                        to="/"
                                        className={`text-decoration-none ${activeLink === "/" ? "active" : ""
                                            }`}
                                        onClick={() => handleClick("/")}
                                    >
                                        Home
                                ...
                                <li className="dropdown">
                                    <Link
                                        to="/our-meals"
                                        className={`text-decoration-none ${activeLink === "/our-meals" ? "active" : ""
                                            }`}
                                        data-bs-toggle="dropdown"
                                        onClick={() => handleClick("/our-meals")}
                                    >
                                ...
                                <li>
                                    <Link
                                        to="/about-us"
                                        className={`text-decoration-none ${activeLink === "/about-us" ? "active" : ""
                                            }`}
                                        onClick={() => handleClick("/about-us")}
                                    >
                                        About Us
                                ...
                                <li>
                                    <Link
                                        to="/blogs"
                                        className={`text-decoration-none ${activeLink === "/blogs" ? "active" : ""
                                            }`}
                                        onClick={() => handleClick("/blogs")}
                                    >
                                        Blogs
                                ...
                                <li>
                                    <Link
                                        to="/contact-us"
                                        className={`text-decoration-none ${activeLink === "/contact-us" ? "active" : ""
                                            }`}
                                        onClick={() => handleClick("/contact-us")}
                                    >
                                        Contact Us
