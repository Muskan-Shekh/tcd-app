...
const Header = () => {
    return (
        <header className="sticky-header bg-custom-dark rounded-bottom-5" style={{ padding: "20px 0" }}>
            ...
            <div className="container d-lg-block d-none">
                <div className="d-flex align-items-center">
                    ...
                    <nav className="d-none d-md-flex" style={{ marginLeft: "auto", marginRight: "90px", gap: "50px" }}>
                        <Link href="/" className="active text-decoration-none" style={{ fontWeight: "500", transition: "all 500ms ease 0ms" }}>
                            Home
                        </Link>
            ...
            <nav class="navbar d-lg-none d-block p-0">
                <div class="container" bis_skin_checked="1">
                    <a class="navbar-brand" href="https://oah.eco-hotels.nl/oah"><svg
                        width="91"
                        height="58"
                        viewBox="0 0 93 59"
                        fill="none"
                    ...
                    <div class="offcanvas offcanvas-start text-bg-white" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" bis_skin_checked="1">
                        <div class="offcanvas-header justify-content-end" bis_skin_checked="1">
                            <button type="button" class="btn_close" data-bs-dismiss="offcanvas" aria-label="Close"><i class="fa-solid fa-xmark"></i></button>
                        </div>
                        <div class="offcanvas-body" bis_skin_checked="1">
                            <ul id="menu-main-menu-1" class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                <li><a title="Home" href="#" class="nav-link">Home</a></li>
                                <li><a title="Our Meals" href="#" class="nav-link">Our Meals</a></li>
                                <li><a title="A bout Us" href="#" class="nav-link">About Us</a></li>                                
                                <li><a title="Blogs" href="#" class="nav-link">Blogs</a></li>
                                <li><a title="Contact Us" href="#" class="nav-link">Contact us</a></li>
