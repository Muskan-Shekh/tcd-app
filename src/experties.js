      ...
      <div className="content-container d-flex flex-row">
        <div className="" style={{paddingTop: "4rem"}}>
          ...
          <p className="text-light">
            TCD is focused on providing wholesome nutritious meals for a healthy
            lifestyle.
          </p>
          ...
          {healthItems.map((item, index) => (
            <div className="health-item" key={index}>
              <div className="icon-circle">
                <img src={item.icon} alt={item.text} className="health-icon fitness-img" />
              </div>
              <span>{item.text}</span>
            </div>
          ))}
    ...
    <section className="partner-rewards container py-5">
      <div className="row align-items-center">
        ...
        <div className="col-md-6">
          <h2 className="fw-bold">
            Become a Partner & <span className="text-custom-success">Earn</span> Rewards
          </h2>
          <p className="fw-semibold fst-italic">Join & Earn Big!</p>
          <p>
            Get hefty cash rewards & free meals—<span className="text-custom-success fw-bold">No investment, Just referrals!</span>
            <br />
            <span className="text-custom-success fw-bold">Earn passive income</span> on every meal package referral. The more you refer, the more you earn!
            <br />
            Don’t miss this easy money-making opportunity!
          </p>
          <button className="btn btn-custom-success rounded-pill p-3">Download the app & start earning today!</button>
        </div>

        {/* Right Side - Image */}
        <div className="col-md-6 text-center">
          <img src={rewardsImage} alt="Rewards" className="img-fluid rewards-img"  />
        </div>
      </div>
    </section>
    ...
    <section className="why-choose-tcd container py-5">
      <div className="row align-items-center">
        ...
        <div className="col-md-7 d-flex flex-row">
            ...
            Why Choose TCD as a Lifetime <span className="text-custom-success">Fitness</span> Partner?
          </h2>
      ...
      >
        <circle cx="12" cy="12" r="10" stroke="" strokeWidth="3" fill="" />
        <path d="M7 12.5L10 16L17 8" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
       ...
       <img src={TCDLOGO} alt="tcd logo" style={{width:"203px", height:"204.47px"}}/>
           </div>

        {/* Right Image */}
        <div className="col-md-5 text-center">
          <img src={mealPlan} alt="Meal Plan" className="img-fluid" style={{width:"491px",height:"593px"}}/>
        </div>
      </div>
    </section>
  </>);
